#!/bin/bash
#SBATCH --chdir=./
#SBATCH --job-name=geothlypis_bam
...
workdir=/lustre/scratch/johruska/central_america_pine_oak/geothlypis

basename_array=$( head -n${SLURM_ARRAY_TASK_ID} ${workdir}/geothlypis_basenames.txt | tail -n1 )

# define the reference genome
refgenome=/lustre/scratch/johruska/central_america_pine_oak/geothlypis_ref/GCA_009764595.1_bGeoTri1.pri_genomic.fna

# define the location of the reference mitogenomes
mito=/lustre/scratch/johruska/central_america_pine_oak/geothlypis_ref/O_tolmiei_FJ236286.1.fasta
