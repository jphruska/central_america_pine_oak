...
pop <- as.factor(c("Highland_El_Salvador", "Highland_Nicaragua", "Highland_Nicaragua", 
                   "Lowland_Nicaragua", 
                   "Highland_El_Salvador")) 



# read in eigen vector and eigen value files 
pca <- read_table2( "plink_out_structure_geothlypis.eigenvec", col_names = FALSE)
eigenval <- scan("plink_out_structure_geothlypis.eigenval")
