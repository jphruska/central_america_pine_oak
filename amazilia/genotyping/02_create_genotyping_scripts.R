...
directory_name <- "11_amazilia_genotype"
reference_genome_location <- "/lustre/scratch/johruska/central_america_pine_oak/amazilia_ref/GCF_003957555.1_bCalAnn1_v1.p_genomic.fna"
cluster <- "nocona"
output_name <- "amazilia_genotype"
popmap <- "amazilia_popmap.txt"
individuals <- read.table(popmap, sep="\t")
faidx <- read.table("GCF_003957555.1_bCalAnn1_v1.p_genomic.fna.fai", stringsAsFactors=F)
