...
singularity exec --bind /lustre/work/johruska:/lustre/work/johruska --bind /lustre/scratch/johruska:/lustre/scratch/johruska $SINGULARITY_CACHEDIR/gatk_4.2.3.0.sif gatk --java-options "-Xmx58g" HaplotypeCaller -R /lustre/scratch/johruska/central_america_pine_oak/amazilia_ref/GCF_003957555.1_bCalAnn1_v1.p_genomic.fna -I /lustre/scratch/johruska/central_america_pine_oak/amazilia/01_bam_files/${ind_array}_final.bam -ERC GVCF -O /lustre/scratch/johruska/central_america_pine_oak/amazilia/02_vcf/${name_array}._${ind_array}_.g.vcf --QUIET --intervals ${chr_array}
