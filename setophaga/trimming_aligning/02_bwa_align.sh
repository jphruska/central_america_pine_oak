...
refgenome=/lustre/scratch/johruska/central_america_pine_oak/setophaga_ref/GCA_001746935.2_mywa_2.1_genomic.fna

# define the location of the reference mitogenomes
mito=/lustre/scratch/johruska/central_america_pine_oak/setophaga_ref/C_canadensis_mito_NC_041111.1.fasta
