...
project_directory <- "/lustre/scratch/johruska/central_america_pine_oak/setophaga"
directory_name <- "11_setophaga_genotype"
reference_genome_location <- "/lustre/scratch/johruska/central_america_pine_oak/setophaga_ref/GCA_001746935.2_mywa_2.1_genomic.fna"
cluster <- "nocona"
