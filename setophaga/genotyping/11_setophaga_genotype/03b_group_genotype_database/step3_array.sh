...
singularity exec --bind /lustre/work/johruska:/lustre/work/johruska --bind /lustre/scratch/johruska:/lustre/scratch/johruska $SINGULARITY_CACHEDIR/gatk_4.2.3.0.sif gatk --java-options "-Xmx87g" GenotypeGVCFs --genomicsdb-shared-posixfs-optimizations -R /lustre/scratch/johruska/central_america_pine_oak/setophaga_ref/GCA_001746935.2_mywa_2.1_genomic.fna -V gendb:///lustre/scratch/johruska/central_america_pine_oak/setophaga/02_vcf/${chr_array} --include-non-variant-sites -O /lustre/scratch/johruska/central_america_pine_oak/setophaga/03_vcf/${name_array}.g.vcf -L ${interval_array}
